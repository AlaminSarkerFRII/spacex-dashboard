            ...
            <div className="flex items-center gap-2">
              ...
              {user ? (
                <button
                  ...
                  className="flex items-center gap-2 rounded-full pl-1 pr-3 py-1 hover:bg-white/5 transition-colors group"
                  aria-label="Open profile"
                >
                  <div className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center text-xs font-bold flex-shrink-0">
                    {initials}
                  </div>
                ...
                <button
                  ...
                  className="px-4 py-1.5 rounded-full bg-white text-black text-sm font-semibold hover:bg-zinc-200 transition-colors"
                >
                  Sign in
                </button>
              )}
